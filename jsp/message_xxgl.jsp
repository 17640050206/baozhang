...
function quizMessage_Onclick(){
	...
	$.ajax({ 
	    ...
	    success : function(data){
	    	if(data.state="true"){
	    		alert("发布成功!");
	    		location.href="<%=request.getContextPath()%>/pubmessage/getallmessage.do";
	    	}else{
	    		alert(data.error);
	    	}
        ...
        <div class="col-md-12">
              <div class="m-column" style="margin-bottom: 0;">
                <div class="header tabheader">
                  <div class="title  act" onclick="xxgl_onClick()">消息管理</div>
                  <div class="title " onclick="btdxx_onClick()">补退单消息</div>
